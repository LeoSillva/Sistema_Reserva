        ...
        <div style="border: 0 solid #555; padding: 10px; box-shadow: 0 0 10px 0 #555;margin: auto;width: 600px;height: 320px">            
              ...
              <form method="POST">
                ...
                <div style="float: left;padding-top: 20px;width: 800px;height: 40px"> 
                    ...
                    <input type="date" name="data_inicio" value="<?php echo $lista2['data_inicio']; ?>" style="margin-left: 30px; border:1px solid gray;padding-left: 10px;width: 210px;height: 30px" required />
                </div>
                <div style="float: left;padding-top: 20px;width: 800px;height: 40px"> 

                    <label style="padding-left: 20px;padding-right: 13px">Data Fim </label>   
                    <input type="date" name="data_fim" value="<?php echo $lista2['data_fim']; ?>"  style="margin-left: 30px; border:1px solid gray;padding-left: 10px;width: 210px;height: 30px" required />
                </div>
                <div style="float: left;padding-top: 20px;width: 800px;height: 40px"> 

                    <label style="padding-left: 20px;padding-right: 30px">Pessoa</label>   
                    <input type="text" name="pessoa" value="<?php echo $lista2['pessoa']; ?>"  style="margin-left: 30px; border:1px solid gray;padding-left: 10px;width: 430px;height: 30px" required />
                </div>
